...
Elm.Lettrs = Elm.Lettrs || {};
Elm.Lettrs.make = function (_elm) {
   "use strict";
   _elm.Lettrs = _elm.Lettrs || {};
   if (_elm.Lettrs.values)
   return _elm.Lettrs.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Text = Elm.Text.make(_elm);
   var main = $Graphics$Element.show($Text.fromString("blah"));
   _elm.Lettrs.values = {_op: _op
                        ,main: main};
   return _elm.Lettrs.values;
};
Elm.List = Elm.List || {};
...
Elm.Styles.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var mainDivStyles = function (styles) {
      return $Css$Dimension.width(300)(A4($Css$Margin.all,
      0,
      10,
      0,
      10)(styles));
   };
   var headingStyles = function (styles) {
      return $Css$Font.size(36)($Css$Font.family("Georgia, Serif")(styles));
   };
   _elm.Styles.values = {_op: _op
                        ,headingStyles: headingStyles
                        ,mainDivStyles: mainDivStyles};
   return _elm.Styles.values;
};
Elm.Task = Elm.Task || {};
